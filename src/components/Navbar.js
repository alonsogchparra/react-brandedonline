...
export const Navbar = () => {
  useEffect(() => {
    window.addEventListener('scroll', () => {
      ...
      const fixedHeader = document.querySelector('.header-web-fixed');
      const showFixedHeader = 'lg:flex';

      if (currentScroll === 0) {
        fixedHeader.classList.remove(showFixedHeader);
      }
      if (currentScroll > 0) {
        fixedHeader.classList.add(showFixedHeader);
      }
    });
  }, []);
  ...
  useEffect(() => {
    window.addEventListener('scroll', () => {
      const currentScroll = window.pageYOffset;
      const mobileHeaderFixed = document.querySelector('.mobile-fixed');
      const showFixedHeader = 'top-0';
      const hideFixedHeader = '-top-20';

      if (currentScroll === 0) {
        mobileHeaderFixed.classList.remove(showFixedHeader);
        mobileHeaderFixed.classList.add(hideFixedHeader);
      }
      if (currentScroll > 0) {
        mobileHeaderFixed.classList.remove(hideFixedHeader);
        mobileHeaderFixed.classList.add(showFixedHeader);
      }
    });
  }, []);
  ...
  return (
    <>
      {/* Responsive */}
      <div className='bg-white flex lg:hidden flex-col py-6'>
        <div className='flex justify-between items-center px-12'>
          <div className='relative'>
            <a href='https://www.google.com' className='flex'>
              <div className='inline-flex justify-center items-center'>
                <div className='flex flex-col justify-between items-center w-4 h-3'>
          ...
          <div className='block mx-auto w-32'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 792 156.23'>
              ...
              <ul className='flex justify-between items-center'>
                <li className='relative'>
                  <a href='https://www.google.com'>
                    ...
                    >
                      <path
                        d='M17.59,16.74l-3.33-3.33a.57.57,0,0,0-.25-.14,8,8,0,1,0-.74.74.57.57,0,0,0,.14.25l3.33,3.33a.59.59,0,0,0,.85,0A.59.59,0,0,0,17.59,16.74ZM8,14.8A6.8,6.8,0,1,1,14.8,8,6.81,6.81,0,0,1,8,14.8Z'
                        fill='#464643'
                      ></path>
                    </svg>
                  </a>
                ...
                <li className='relative flex'>
                  <a href='https://www.google.com'>
                    ...
                    >
                      <path
                        d='M17.05,5.92a.6.6,0,0,0-.6-.52H13.6V4.5a4.1,4.1,0,0,0-8.2,0v.9H2.55a.6.6,0,0,0-.6.52L.4,17.92a.65.65,0,0,0,.15.48.59.59,0,0,0,.45.2H18a.59.59,0,0,0,.45-.2.6.6,0,0,0,.14-.48ZM6.6,4.5a2.9,2.9,0,1,1,5.8,0v.9H6.6ZM1.68,17.4,3.07,6.6H15.93l1.39,10.8Z'
                        transform='translate(-0.4 -0.4)'
                        fill='#464643'
                      ></path>
                    </svg>
                  </a>
                  <span className='gtamerica'>0</span>
                </li>
              </ul>
            </nav>
          </div>
      ...
      {/* Responsive fixed */}
      <div className='bg-white fixed lg:hidden flex-col py-6 w-full z-50 -top-20  mobile-fixed'>
        <div className='flex justify-between items-center px-12'>
          <div className='relative'>
            <a href='https://www.google.com' className='flex'>
              <div className='inline-flex justify-center items-center'>
      ...
      <div className='bg-white hidden lg:flex flex-col py-6'>
        <div className='w-full flex justify-between px-12'>
              ...
              <div className='absolute left-24 top-1'>
                ...
                >
                  ...
                  >
                    <g
                      id='Desktop@2x'
                      transform='translate(-109.000000, -78.000000)'
                      fill-rule='nonzero'
                      stroke='#464643'
                    >
                      <g id='CS' transform='translate(25.000000, 79.000000)'>
                        <path
                          d='M103.30978,0.913272631 L99.4504832,0.0226664413 C99.0311558,-0.0738158959 98.6006958,0.145124792 98.4299961,0.538475859 L96.6487824,4.69463808 C96.4929262,5.05830227 96.5968303,5.48505107 96.9048318,5.73367863 L99.1536142,7.57426476 C97.8177039,10.4204937 95.4835717,12.7880218 92.5779667,14.1499071 L90.7373792,11.9011265 C90.4850406,11.5931252 90.0620023,11.4892211 89.6983378,11.6450772 L85.5421724,13.4262896 C85.1451101,13.6007 84.9261693,14.0311596 85.0226517,14.4504867 L85.9132586,18.3097802 C86.0060301,18.710553 86.3622729,19 86.7816003,19 C96.2851179,19 104,11.2999673 104,1.78161367 C104,1.36599744 103.714264,1.00604411 103.30978,0.913272631 Z'
                          id='Phone'
                        ></path>
                      </g>
                    </g>
              ...
              <div className='absolute left-32 top-2'>
                ...
                >
                  ...
                  >
                    <g
                      id='Desktop@2x'
                      transform='translate(-140.000000, -82.000000)'
                      fill='#464643'
                      fill-rule='nonzero'
                    >
                      <g id='CS' transform='translate(25.000000, 79.000000)'>
                        <path
                          d='M135,17.2857143 L115,17.2857143 L115,3 L135,3 L135,17.2857143 Z M122.472222,11.0802198 L116.861111,16.2076923 L133.138889,16.2076923 L127.527778,11.0802198 L125,12.9230769 L122.472222,11.0802198 Z M133.935556,6.40659341 L128.413333,10.4318681 L133.935556,15.4758242 L133.935556,6.40659341 Z M116.066667,6.40659341 L116.066667,15.4769231 L121.588889,10.432967 L116.066667,6.40659341 Z M116.066667,4.07692308 L116.066667,5.08791209 L125,11.5934066 L133.935556,5.08791209 L133.935556,4.07692308 L116.066667,4.07692308 Z'
                          id='Shape'
                        ></path>
                      </g>
                    </g>
          ...
          <div className='block lg:w-44 z-10 sticky left-0 right-0 '>
            <a href='index.html' title='Karen Kane'>
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 792 156.23'>
                <path d='M0,0,6.37.07C8.09.09,8-.18,8,1.64V80.92a3.85,3.85,0,0,0,1-.56c3.38-4.3,6.73-8.63,10.11-12.94s7-8.86,10.49-13.31c3.19-4,6.32-8.14,9.51-12.2,3.77-4.8,7.59-9.57,11.36-14.37s7.31-9.41,11-14.1Q66.43,7,71.48.61A1.23,1.23,0,0,1,72.22.1c1.19,0,2.39,0,3.84,0L73,4.13q-5.43,7.11-10.87,14.21C58,23.71,53.82,29.05,49.69,34.41c-3.08,4-6.12,8-9.19,12.05-3.44,4.48-6.91,8.94-10.35,13.42-3.08,4-6.13,8-9.2,12q-2,2.6-4,5.16A1.12,1.12,0,0,0,17,78.8c3.15,3.37,6.26,6.78,9.37,10.19,2.75,3,5.49,6.05,8.24,9.07l10.44,11.49q4,4.45,8.08,8.92l8.31,9.15,8.23,9.08c2.77,3.05,5.55,6.09,8.31,9.15,2.59,2.87,5.16,5.76,7.83,8.74-.38,0-.67.06-1,.06-2.84,0-5.68-.11-8.5,0a3.9,3.9,0,0,1-3.42-1.63q-2.24-2.59-4.52-5.15-4.62-5.16-9.25-10.29c-1.38-1.54-2.79-3.08-4.18-4.62q-4.62-5.14-9.25-10.28c-1.43-1.6-2.89-3.18-4.33-4.77-3.24-3.58-6.46-7.17-9.7-10.74-1.71-1.87-3.45-3.71-5.16-5.59C23.25,98,20,94.37,16.69,90.75q-2.39-2.62-4.79-5.22c-.9-1-1.8-2-2.74-2.94A7.46,7.46,0,0,0,8,81.81v71.37c0,1.47,0,1.49-1.51,1.47-2.16,0-4.31-.08-6.47-.12Z'></path>
0,1.59,0,3,0,4.5,0,.23-.24.5-.43.69-5.3,5.29-10.94,10.14-17.82,13.33a40.82,40.82,0,0,1-13.57,3.7c-.94.09-1.9.12-2.84.24-.25,0-.47.3-.7.46ZM709,70.28h74.22a10.31,10.31,0,0,0-.11-1.71c-.29-1.23-.62-2.45-1-3.66a35.66,35.66,0,0,0-40-25,38,38,0,0,0-19.24,9.25,47.37,47.37,0,0,0-13.09,18.79C709.5,68.65,709.27,69.41,709,70.28Z'></path>
          ...
          <div className='flex origin-top-right right-10'>
            <nav className='mr-0 flex w-full'>
              <ul className='flex justify-center items-center'>
                <li className='md:relative px-3'>
                  <a href='https://www.google.com' className='flex-row'>
                    <span className='nav-item-title font-light text-primary'>
                      Search
                    </span>
                  </a>
                </li>
        ...
        <nav className='w-full flex justify-center items-center pt-6 pb-2 container mx-auto'>
          <ul className='flex items-center'>
            <li className='md:relative px-3 font-light text-primary'>
              New Arrivals
            </li>
            <li className='md:relative px-3 font-light text-primary'>
              Clothing
      ...
      {/* fixed web */}
      <div className='hidden fixed w-full z-50 top-0 header-web-fixed'>
        <div className='bg-white py-10 w-full flex justify-between px-10'>
          {/* logo */}
          <div className=''>
            <div className='block lg:w-44 z-10 sticky left-0 right-0 '>
              <a href='index.html' title='Karen Kane'>
          ...
          <div className='w-full flex justify-center items-center mx-auto'>
            {/* <nav className='w-full flex justify-center items-center pt-6 pb-2 container mx-auto'> */}
            <nav className='w-full flex justify-center items-center pb-2 container mx-auto'>
                ...
                <li>
                  <a href='https://www.google.com'>
                    ...
                    >
                      ...
                      >
                        <g
                          id='Desktop-Scroll@2x'
                          transform='translate(-1237.000000, -18.000000)'
                          fill-rule='nonzero'
                          stroke='#464643'
                          stroke-width='1.2'
                        >
                          <g id='SHORT-NAV'>
                            <path
                              d='M1248.16129,19 C1242.54877,19 1238,22.740625 1238,27.3571429 C1238,29.35 1238.84942,31.1741071 1240.26247,32.6084821 C1239.76632,34.6334821 1238.10717,36.4375 1238.08732,36.4575893 C1238,36.55 1237.97618,36.6866071 1238.02778,36.8071429 C1238.07939,36.9276786 1238.19052,37 1238.31754,37 C1240.94916,37 1242.92188,35.7223214 1243.89831,34.9348214 C1245.19626,35.4290179 1246.6371,35.7142857 1248.16129,35.7142857 C1253.77382,35.7142857 1258.32258,31.9736607 1258.32258,27.3571429 C1258.32258,22.740625 1253.77382,19 1248.16129,19 Z'
                              id='chat'
                            ></path>
                          </g>
                        </g>
                  ...
                  <a href='https://www.google.com'>
                    ...
                    >
                      ...
                      >
                        <g
                          id='Desktop-Scroll@2x'
                          transform='translate(-1321.000000, -19.000000)'
                          stroke='#464643'
                          stroke-width='1.2'
                        >
                          <g
                            id='account'
                            transform='translate(1322.000000, 19.000000)'
                          >
                            <circle
                              id='Oval'
                              cx='8.94117647'
                            ...
                            ></circle>
                            <path
                              d='M17.8823529,17.25 C17.8823529,13.3515194 13.8792519,9.25 8.94117647,9.25 C4.00310106,9.25 5.68434189e-14,13.3515194 5.68434189e-14,17.25 C2.03753303,17.25 15.1874497,17.25 17.8823529,17.25 Z'
                              id='Oval-Copy'
