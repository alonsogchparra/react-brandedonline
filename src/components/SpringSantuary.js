...
export const SpringSantuary = () => {
  return (
    <div className='mt-14 mb-10'>
      <h2 className='playfair text-4xl text-center'>Your Spring Sanctuary</h2>
      <div className='my-4'>
        <p className='gtamerica text-center'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 sm:gap-5 sm:px-24 mt-10'>
        ...
        <div className='row-start-2 py-10 px-8 sm:py-1 sm:px-0'>
          <h2 className='playfair text-3xl'>Most Loved Artisan Jewelry</h2>
          <p className='gtamerica my-2'>
        ...
        <div className='py-10 px-8 sm:py-1 sm:px-0'>
          <h2 className='playfair text-3xl'>New Flattering Fits</h2>
          <p className='gtamerica my-2'>
